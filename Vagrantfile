...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "bkaraoglanov-starter"
  ...
  #   chef.chef_server_url = "https://test-chef-server-vpc/organizations/p6"
  #   chef.validation_client_name = "p6-validator"
  #   chef.validation_key_path = ".chef/p6-validator.pem"
  # end
end
